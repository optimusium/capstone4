...
def createModel():
    ...
    x0 = Dense(64,activation="relu", kernel_initializer='he_normal')(inputs)
    x1 = Dense(64,activation="relu", kernel_initializer='he_normal')(inputs)
    x2 = Dense(64,activation="relu", kernel_initializer='he_normal')(inputs)
    x3 = Dense(64,activation="relu", kernel_initializer='he_normal')(inputs)
