...
def process_csv():
    ...
    X26 = loadtxt('img26_merged_representation.csv', delimiter=',')
    ...
    Y0=np.append( Y0, np.ones(X26.shape[0]),axis=0)
    ...
    Y1=np.append( Y1, np.zeros(X26.shape[0]),axis=0)
    ...
    Y2=np.append( Y2, np.zeros(X26.shape[0]),axis=0)
    ...
    Y3=np.append( Y3, np.zeros(X26.shape[0]),axis=0)
    ...
    X=np.append(X,X26,axis=0)
    '''
    X = loadtxt('dlib_merged_representation.csv', delimiter=',')
    Y0 = loadtxt('dlib_merged_representation_result.csv', delimiter=',')
    ...
    #Y0 = np.where(Y0==12,996,Y0)
    Y0 = np.where(Y0<25,1000,Y0)
    Y0 = np.where(Y0<28,999,Y0)
    Y0 = np.where(Y0<44,997,Y0)
    Y0 = np.where(Y0==44,998,Y0)
    ...
    Put
    Y0 = np.where(Y0==56,1000,Y0)
    BEfore Y=1000-Y0
    
    If frame56.jpg is boonping
    Y0 = np.where(Y0==56,997,Y0)
    If frame56.jpg is Yu Ka
    Y0 = np.where(Y0==56,998,Y0)
    If frame56.jpg is Francis
    Y0 = np.where(Y0==56,997,Y0)
