...
eclf1 = VotingClassifier(estimators=[ ('mlp', model3), ('lr', model7), ('knn', model11), ('svm', model19)], voting='soft', weights=[1,1,1,1])
...
eclf2 = VotingClassifier(estimators=[ ('mlp', model4), ('lr', model8), ('knn', model12), ('svm', model20)], voting='soft', weights=[1,1,1,1])
...
eclf3 = VotingClassifier(estimators=[ ('mlp', model5), ('lr', model9), ('knn', model13), ('svm', model21)], voting='soft', weights=[1,1,1,1])
...
eclf4 = VotingClassifier(estimators=[ ('mlp', model6), ('lr', model10), ('knn', model14), ('svm', model22)], voting='soft', weights=[1,1,1,1])
