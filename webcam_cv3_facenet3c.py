...
def check_contradict(result2,result3,result4,result5):
    contradict=0
    if contradict==0:
        for i in [result2,result3,result4,result5]:
            for j in [result2,result3,result4,result5]:
                if i==j:
                    contradict=1
                    break
    return contradict
    
def preprocessNpredict(resized,result,detector):
    if 1:
...
-        ######################
        ...
        contradict=check_contradict(result2,result3,result4,result5)
        ...
        contradict=check_contradict(result6,result7,result8,result9)
        ...
        contradict=check_contradict(result10,result11,result12,result13)
        ...
        contradict=check_contradict(result14,result15,result16,result17)
        
        if result2==1 and result6==1 and result10==0:
            contradict=1
        if result3==1 and result7==1 and result11==0:
            contradict=1
        if result4==1 and result8==1 and result12==0:
            contradict=1
        if result5==1 and result9==1 and result13==0:
            contradict=1

        if result2==0 and result6==0 and result10==1:
            contradict=1
        if result3==0 and result7==0 and result11==1:
            contradict=1
        if result4==0 and result8==0 and result12==1:
            contradict=1
        if result5==0 and result9==0 and result13==1:
            contradict=1
...
while True:
    ...
    for (x, y, w, h) in faces:
        ...
        val,sel,contradict=preprocessNpredict(resized,result,detector)
        
        if contradict==1:
            resized=adjust_gamma(resized,gamma=1.5)
            
            val,sel,contradict=preprocessNpredict(resized,result,detector)
            print("adjust gamma 1.5")
            grayplt(resized/255)
        if contradict==1:
            resized=adjust_gamma(resized,gamma=0.8)
            val,sel,contradict=preprocessNpredict(resized,result,detector)
            print("adjust gamma 0.8")
